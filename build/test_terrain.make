...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/test_terrain
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/test_terrain
  DEFINES   += -DDEBUG
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/test_terrain
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/test_terrain
  DEFINES   += 
  INCLUDES  += -I../.. -I../../src/gKit -I../src
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/debug/test_terrain
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/test_terrain
  DEFINES   += -DDEBUG
  INCLUDES  += -I../.. -I../../src/gKit -I../src
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/test_terrain
  TARGETDIR  = ../bin
  TARGET     = $(TARGETDIR)/test_terrain
  DEFINES   += 
  INCLUDES  += -I../.. -I../../src/gKit -I../src
...
$(OBJDIR)/player.o: ../src/player.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/test_terrain.o: ../app/test_terrain.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
